    ...
    <div class="content-wrapper admin-content">
        <div class="admin-page-head">
            <div>
                ...
                <h2 class="admin-page-title mb-2"><?= $isEdit ? 'Edit Knowledge Base' : 'Tambah Knowledge Base' ?></h2>
                <p class="admin-page-subtitle mb-0">Data aktif akan langsung dipakai chatbot sebagai sumber response lokal.</p>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="pertanyaan" name="pertanyaan" rows="3" required><?= esc(old('pertanyaan', $item['pertanyaan'] ?? '')) ?></textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="keyword">Keyword</label>
                                <textarea class="form-control" id="keyword" name="keyword" rows="3" required
                                    placeholder="Pisahkan keyword dengan koma"><?= esc(old('keyword', $item['keyword'] ?? '')) ?></textarea>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                <label class="form-label" for="intent">Intent</label>
                                <input class="form-control" id="intent" name="intent" type="text" required
                                    value="<?= esc(old('intent', $item['intent'] ?? '')) ?>"
