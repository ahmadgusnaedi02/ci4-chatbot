                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="response" name="response" rows="12"
                                    style="min-height: 380px;"
                                    required><?= esc(old('response', $item['response'] ?? '')) ?></textarea>
                            </div>
                        </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="status" name="status">
                                    ...
                                    <option value="inactive" <?= $currentStatus === 'inactive' ? 'selected' : '' ?>>
                                        Inactive</option>
                                    <option value="draft" <?= $currentStatus === 'draft' ? 'selected' : '' ?>>Draft
                                    </option>
                                </select>
                            </div>
